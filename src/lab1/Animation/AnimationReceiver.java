...
public class AnimationReceiver extends JPanel {
    ...
    * 
    */
    private final static long serialVersionUID = 883685472198767973L;
    /**
     * 
     */
    public static int PORT = 8889; // host port number
	...
	try {
	    System.out.println(
		    "Receiver started at " + InetAddress.getLocalHost() + " on port " + AnimationReceiver.PORT);
	...
	try {
	    socket = new DatagramSocket(AnimationReceiver.PORT);
